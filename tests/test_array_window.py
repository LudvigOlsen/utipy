...
def test_window_list_rolling():
	...
	w1, nw1 = ut.window(x1, size = 2, gap=1, sample_rate = 1, 
           ...
           discard_shorts=True)
	w1_ = [np.array([1,2]),np.array([2,3]),np.array([3,4]),np.array([4,5]),np.array([5,6])]

	w2, nw2 = ut.window(x1, size = 2, gap=1, sample_rate = 1, 
           rolling=True, reverse_direction = True,
           discard_shorts=True)
	w2_ = [np.array([5,6]),np.array([4,5]),np.array([3,4]),np.array([2,3]),np.array([1,2])]
	...
	w5, nw5 = ut.window(x1, size = 4, gap=1, sample_rate = 1, 
           rolling=True, reverse_direction = False,
           discard_shorts=True)
	w5_ = [np.array([1,2,3,4]),np.array([2,3,4,5]),np.array([3,4,5,6])]

	w6, nw6 = ut.window(x1, size = 4, gap=1, sample_rate = 1, 
           rolling=True, reverse_direction = True,
           discard_shorts=True)
	w6_ = [np.array([3,4,5,6]),np.array([2,3,4,5]),np.array([1,2,3,4])]
...
def test_window_sample_rate():
	...
	w1, nw1 = ut.window(x1, size = 2, gap=1, sample_rate = 2, 
           rolling=True, reverse_direction = False,
           discard_shorts=True)
	w1_ = [np.array([1,2,3,4]),np.array([3,4,5,6]),np.array([5,6,7,8]),np.array([7,8,9,10]),np.array([9,10,11,12])]

	w2, nw2 = ut.window(x1, size = 2, gap=1, sample_rate = 2, 
           rolling=False, reverse_direction = False,
           discard_shorts=True)
	w2_ = [np.array([1,2,3,4]),np.array([7,8,9,10])]
